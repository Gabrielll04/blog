...
export default function SideBar() {
  return (
    <div className='flex items-center justify-center space-x-32 w-full h-12 sm:h-20 z-10 sm:text-xl sm:px-0 px-3'>
      <button><SiGithub className='text-4xl sm:hover:scale-110 transition invisible sm:visible' /></button>
